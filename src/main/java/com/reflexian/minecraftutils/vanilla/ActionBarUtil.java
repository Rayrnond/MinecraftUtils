...
public class ActionBarUtil {
    ...
    private static String nmsver="v1_8_R3";
    ...
    public static void initUtil(Plugin p) {
        plugin=p;
    ...
    public static void sendActionBar(final Player player, final String message, int duration) {
        ...
        if (duration >= 0) {
            // Sends empty message at org.bukkit.craftbukkit.null.entity.CraftPlayere end of the duration. Allows messages shorter than 3 seconds, ensures precision.
            new BukkitRunnable() {
                @Override
                public void run() {
